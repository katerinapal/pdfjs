...
exports.default = function (string, opts) {
  var text = new Text(this, opts);
  if (typeof string === 'function') string.call(text, text.textFn);else text.text(string);
...
var Text = exports.Text = function Text(doc, opts) {
  this.doc = doc;
  this.opts = opts || {};
  this.contents = [];
...
Text.prototype.text = function text(str, opts) {
  ...
  var self = this,
      font = (opts.font ? this.doc.registerFont(opts.font) : this.doc.defaultFont).fromOpts(opts);
...
Text.prototype.render = function (page, width, context) {
  ...
  function renderLine(line, textWidth, isLastLine) {
    ...
    line.forEach(function (word, i) {
      ...
      page.contents.writeLine(new _string2.default(str).toHexString() + ' Tj');
    });
  ...
  this.contents.forEach(function (word) {
    ...
    var wordWidth = word.width,
        wordSpacing = !line.length || word.isStartingWithPunctuation ? 0 : word.spacing;
...
var Word = function Word(word, font, opts) {
  this._word = word;
  this.font = font;
  this.opts = opts || {};
  this.context = {};
