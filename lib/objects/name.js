...
var PDFName = function PDFName(name) {
  ...
  if (name.match(/[\x00]/)) throw new Error('A Name mustn\'t contain the null characters');

  // delimiter characters are not allowed
  if (name.match(/[\(\)<>\[\]\{\}\/\%]/)) throw new Error('A Name mustn\'t contain delimiter characters');
